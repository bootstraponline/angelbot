...
class GerritJiraTranslator < SlackbotFrd::Bot
  def whitelisted_prefixes
    'ADMIN|AMS|ARC|BR|BUC|CAR|CAT|CM|CNVS|COMMS|CORE|CYOE|DIG|DS|EISR|FALCOR|GOOF|GRADE|HOLLY|IMPENG|INSTUI|ITSD|MBL|MC|NTRS|OPS|OUT|PANDA|PFS|PLAT|PRAC|QO|QUIZ|RD|SE|SEC|TALENT|TS'
  end
